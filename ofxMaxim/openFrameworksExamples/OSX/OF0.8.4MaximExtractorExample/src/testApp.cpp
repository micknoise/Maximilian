...
void testApp::draw(){
    ...
    myfont.drawString(peakString, horizOffset, chromagramTop + 50);
    
    char centroidString[255]; // an array of chars
    sprintf(centroidString, "Spectral Centroid: %f", centroid);
    myfont.drawString(centroidString, horizOffset, chromagramTop + 100);
    
    char rmsString[255]; // an array of chars
    sprintf(rmsString, "RMS: %.2f", RMS);
    myfont.drawString(rmsString, horizOffset, chromagramTop + 150);
